...
$l['denied_support'] = "This user has been denied support.";
...
$l['error_no_action'] = "Please select a new status, user to assign the thread to, priority or category.";
