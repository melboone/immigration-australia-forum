...
$config['database']['database'] = 'immymybb';
$config['database']['table_prefix'] = 'immigrationaustralia_';

$config['database']['hostname'] = 'immymybb.db.10830367.hostedresource.com';
$config['database']['username'] = 'immymybb';
$config['database']['password'] = 'd#kMu8M95M2IM@';
